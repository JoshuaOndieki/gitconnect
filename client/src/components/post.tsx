            ...
            <div className={cn('border border-gray-200 dark:border-gray-700 rounded p-2 mx-2 my-4', styleClass)}>
                <div className='flex justify-between'>
                    <div className="flex items-center gap-4">
                        ...
                        <div className="font-medium dark:text-white">
                            <div>{post.user.name} <span className='text-gray-400'>@{post.user.username}</span></div>
                    ...
                    <div>
                        <button data-dropdown-toggle={"dropdownPost-" + post.$id}
                                className="inline-flex items-center p-2 text-sm font-medium text-center text-gray-500 rounded hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-50 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                                type="button">
                ...
                <div className='flex justify-end gap-2'>
                    <div
                        ...
                        <a type="button" href={'/posts/' + post.$id}
