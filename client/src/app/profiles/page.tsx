                        ...
                        <div className="grid gap-8 mb-6 lg:mb-8 md:grid-cols-2 xl:grid-cols-3">
                            <div
                                ...
                                <a href="#" className='sm:relative sm:w-full sm:h-full'>
                                    <img className="w-full sm:h-full rounded sm:rounded-none sm:rounded-l-lg sm:object-cover"
                                         src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/bonnie-green.png"
                                         alt="Bonnie Avatar"/>
                                </a>
                                <div className="py-2 px-5">
                                    <h3 className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                        <a href="#">Bonnie Green <span className='text-gray-400 text-sm'>@oj</span></a>
                                    </h3>
                                    <span className="text-gray-500 dark:text-gray-400">CEO & Web Developer</span>
                                    <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Bonnie drives
                            ...
                            <div
                                ...
                                <div className="py-2 px-5">
                                    ...
                                    <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">Michael drives
                                        the technical strategy of the flowbite platform and brand.</p>
                                    <ul className="flex space-x-4 sm:mt-0 justify-end">
                                        <li>
                                            <a href="#"
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" className="px-4 py-3">No. Of Posts</th>
                                        <th scope="col" className="px-4 py-3">Date Joined</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    {developers.map(dev =>
                                        <tr className="border-b dark:border-gray-700" key={dev.username}>
                                            <th scope="row"
                                                className="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white flex items-center">
                                                <img src='/images/oj.jpg' className='h-[48px] w-[48px] rounded-full' alt='avatar'/>
                                                <span className='ml-2 mr-1'>{dev.name}</span>
                                                <span className='text-gray-400'>@{dev.username}</span>
                                            </th>
                                            <td className="px-4 py-3">{dev.title}</td>
                                            <td className="px-4 py-3">{dev.postsCount}</td>
                                            <td className="px-4 py-3">{dev.joined}</td>
                                        </tr>
                                    )}
                                    </tbody>
                                </table>
