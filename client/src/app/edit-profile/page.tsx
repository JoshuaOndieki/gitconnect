...
function EditProfile() {
    ...
    const addWork = ()=> {
        if(profile) {
            setProfile({...profile, work: [{$id: "", company: "", endDate: null, startDate: "", title: ""}, ...profile.work]})
        }
    }
    ...
    const addSchool = ()=> {
        if(profile) {
            setProfile({...profile, schools: [{$id: "", name: "", endDate: null, startDate: "", course: ""}, ...profile.schools]})
        }
    }
    ...
    const validateForm = () => {
        ...
        if (!parsed.success) {
            ...
            setErrors(newErrors);
            console.log('work', formattedErrors.work)
            return null
        } else {
            ...
            <section className="bg-white dark:bg-gray-900">
                ...
                <div className="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form onSubmit={updateProfile}>
                        <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div className='flex  items-center justify-between sm:col-span-2'>
                                ...
                                <button type="button" onClick={addWork}
                                        className="text-center inline-flex items-center py-1 px-3 me-2 mb-2 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700">
                                ...
                                {profile?.work.map((work, index) => (
                                    <div key={work.$id}
                                        ...
                                        <div className="w-full my-2">
                                            ...
                                            <input type="text" name="work-company" id={"work-company-" + work.$id + '-' + index} defaultValue={work.company}
                                                   onChange={event => updateWork(index, {...work, company: event.target.value})}
                                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        ...
                                        <div className="w-full my-2">
                                            ...
                                            <input type="text" name="work-title" id={'work-title-' + work.$id + '-' + index} defaultValue={work.title}
                                        ...
                                        <div
                                            ...
                                            <div className="flex-1">
                                                {work.endDate ?
                                                    ...
                                                    :
                                                    <div className='p-2.5 rounded bg-gray-50 dark:bg-gray-700 text-center text-sm border border-gray-300 dark:border-gray-600'>Present</div>
                                                }
                                            </div>
                                        </div>

                                        <div className="flex items-center mb-4 sm:col-span-2">
                                            <input id={'work-current-checkbox-' + work.$id + '-' + index} type="checkbox" checked={!work.endDate}
                                ...
                                {profile?.schools.map((school, index) => (
                                    <div key={school.$id}
                                        ...
                                        <div className="w-full my-2">
                                            ...
                                            <input type="text" name="school-course" id={'school-course-' + school.$id + '-' + index} defaultValue={school.course}
                                                   onChange={event => updateSchool(index, {...school, course: event.target.value})}
                                                   className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                        ...
                                        <div className="flex items-center mb-4 sm:col-span-2">
                                            <input type="checkbox" id={'school-current-checkbox-' + school.$id + '-' + index} checked={!school.endDate}
                        ...
                        <Button disabled={Object.values(errors).some(error => !_.isEmpty(error))} isProcessing={updating}
                                type="submit" className="mt-4 sm:mt-6 w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded text-sm text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            Update Profile
                        </Button>
                    </form>
                </div>
