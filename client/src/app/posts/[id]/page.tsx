...
function PostPage() {
    ...
    const comments = [
        {$id: '1', content: 'COMMENT. GitConnect allows developers to create a developer profile/portfolio, share posts and get help from others developers'},
        {$id: '2', content: 'COMMENT. GitConnect allows developers to create a developer profile/portfolio, share posts and get help from others developers'},
        {$id: '3', content: 'COMMENT. GitConnect allows developers to create a developer profile/portfolio, share posts and get help from others developers'},
    ]
            ...
            <>
                {loading ?
                    ...
                    post ?
                                ...
                                <div className='flex justify-between'>
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="font-medium dark:text-white">
                                            <div>{post.user.name} <span
                                                className='text-gray-400'>@{post.user.username}</span>
                                            </div>
                            ...
                            <form>
                                <div
                                    ...
                                    <div
                                        ...
                                        <button type="submit"
                                                className="inline-flex items-center py-2.5 px-4 text-xs font-medium text-center text-white bg-primary-700 rounded focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                                            Post comment
                                        </button>
                                    </div>
                                </div>
                        ...
                        : <div className='text-red-400 flex-1 flex items-center justify-center'>{fetchStatus?.message}</div>
                }
            </>
    );
}
